class FormSubmition{
    constructor(form_id, rules, request_type="ajax", functionToRun=null ){
        //console.log(form_id, rules, route, id_for_backend_errors, callback)
        ...
        axios.post(this.route, form_data).then((data)=>{
            //console.log(data)
             if(this.callback){
                 ...
                 console.log('Nothing to do after ajax request...')
             }
            //return data;
        });
    }
        ...
        for(let [input_name, object_rules_for_input] of Object.entries(this.rules)){
            ...
            for(let [method_name, arg_value] of Object.entries(object_rules_for_input)){
                ...
                if(typeof this[method_name] === "function"){
                    ...
                    alert('There is no method name '+method_name)
                }
            }
        }
    }
    ...
    putErrorsAboveEveryInput(errorsObject=this.errorsObj, arrayOfClasses=['alert', 'alert-danger'], tagName="p"){
        //console.log(errorsObject)//, arrayOfClasses, tagName);return;
        this.deleteErrorMessages();
